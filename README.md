...
В папке Controllers лежат контроллеры, которые обрабатывают входящие запросы. Каждый метод контроллера обрабатывает одну операцию.
...
**!** Должен быть установлен Docker Desktop
